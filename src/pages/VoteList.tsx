...
export const MOCK_TEAMS: Team[] = [
  { id: 101, activityId: 2, name: '朝阳太极之光', slogan: '太极生两仪，舞动夕阳红', img: 'https://images.unsplash.com/photo-1552084117-56a98a96e1b7?w=400', votes: 1250, todayVotes: 45, rank: 1 },
  { id: 102, activityId: 1, name: '滨江活力舞蹈队', slogan: '活力四射，舞出自我！', img: 'https://images.unsplash.com/photo-1543807535-eceef0bc6599?w=400', votes: 1120, todayVotes: 30, rank: 2 },
  { id: 103, activityId: 3, name: '老干部合唱团', slogan: '唱响夕阳红，歌声满天下', img: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400', votes: 980, todayVotes: 15, rank: 3 },
  { id: 104, activityId: 4, name: '深圳银发模特队', slogan: '走出自信风采，展现银发魅力', img: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400', votes: 850, todayVotes: 50, rank: 4 },
  { id: 105, activityId: 6, name: '浦东新区象棋队', slogan: '棋逢对手，乐在其中', img: 'https://images.unsplash.com/photo-1529699211952-734e80c4d42b?w=400', votes: 720, todayVotes: 10, rank: 5 },
  { id: 106, activityId: 5, name: '青羊区书法协会', slogan: '笔墨丹青，传承文化', img: 'https://images.unsplash.com/photo-1544626129-8472f8837eec?w=400', votes: 650, todayVotes: 5, rank: 6 },
  { id: 107, activityId: 1, name: '西湖区广场舞之星', slogan: '舞动西湖，展现风采', img: 'https://images.unsplash.com/photo-1504609774514-cb18d022b72a?w=400', votes: 540, todayVotes: 12, rank: 7 },
  { id: 108, activityId: 2, name: '天河区太极拳队', slogan: '行云流水，刚柔并济', img: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=400', votes: 420, todayVotes: 8, rank: 8 },
  { id: 109, activityId: 3, name: '越秀区金秋合唱团', slogan: '金秋岁月，歌声嘹亮', img: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400', votes: 380, todayVotes: 5, rank: 9 },
  { id: 110, activityId: 4, name: '福田区风采模特队', slogan: '时尚不分年龄', img: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400', votes: 350, todayVotes: 18, rank: 10 },
  { id: 111, activityId: 5, name: '武侯区墨香书画社', slogan: '墨香四溢，书画人生', img: 'https://images.unsplash.com/photo-1544626129-8472f8837eec?w=400', votes: 310, todayVotes: 6, rank: 11 },
  { id: 112, activityId: 6, name: '闵行区楚汉棋社', slogan: '楚汉争霸，智者胜', img: 'https://images.unsplash.com/photo-1529699211952-734e80c4d42b?w=400', votes: 290, todayVotes: 4, rank: 12 },
];
    ...
    <PageWrapper type="fade">
      ...
      >
        ...
        <div className="sticky top-0 left-0 w-full h-[88px] flex items-end justify-between px-5 pb-[10px] z-[100] bg-[#f0f2f5]/80 backdrop-blur-md">
          ...
          <div className="text-[17px] font-bold text-[#111]">人气投票</div>
          <div 
            className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center cursor-pointer"
        ...
        <div className="mx-5 mt-2 mb-5 bg-white rounded-[24px] p-5 shadow-[0_8px_20px_rgba(0,0,0,0.03)]">
          ...
          <div className="bg-gradient-to-r from-[#fff4ed] to-[#fffaf5] rounded-[16px] p-4 border border-[#ffe4cc]">
            ...
            <div className="text-[12px] text-[#d97706] leading-relaxed opacity-80">
